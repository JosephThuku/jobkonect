...
def employer_sign_up(request):
    ...
    if request.method == "POST":
        ...
        if User.objects.filter(username=username).exists():
            ...
            employer.save()
            subject = 'Welcome to Jobkonect'
            message = f'Hi {firstname}, thank you for registering with Jobkonect. your username is {username} and your password is {password}.'
            email_from = 'jnduta141@gmail.com'
...
def employee_sign_up(request):
    ...
    if request.method == "POST":
        ...
        new_employee.save()
        subject = 'Welcome to Jobkonect'
        message = f'Hi {firstname}, thank you for registering with Jobkonect. your username is {user_name} and your password is {password}.'
        email_from = 'jnduta141@gmail.com'
        recipient_list = [email,]
        send_mail( subject, message, email_from, recipient_list )
        return redirect('/account/login')
